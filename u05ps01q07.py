...
def cached_execution(cache, proc, proc_input):
    if proc_input in cache:
        ...
        cache[proc_input] = output
        return cache[proc_input]
    # it looks like my habit of making variables for
    # everything just ends up making my code bigger.
    # (and more redundant)
    # To be fair though, while I knew defining output
    # would execute the function being defined in output,
    # I didn't realize the same would happen when adding
    # the function's result to the cache.
    # I guess I need to get in the habit of minimizing my
    # code as well as creating it. Though once I know it
    # works I don't really want to spend more time on it.
    # In future code however I will keep these shortcuts in
    # mind!
